...
BLOG_AUTHOR = "Charles Martineau"  # (translatable)
BLOG_TITLE = "Charles Martineau - University of Toronto"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.charlesmartineau.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.charlesmartineau.com/"
BLOG_EMAIL = "martineau.charles@gmail.com"
BLOG_DESCRIPTION = "Personal webpage"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
       ("/pages/research/index.html", "Research"),
